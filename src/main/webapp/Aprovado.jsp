<%-- 
    Document   : Aprovado
    Created on : 29/11/2016, 06:51:46
    Author     : Lucas
--%>
...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="5; url=promocao.jsp">
    ...
    <body>
        <div class="container">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-3">A Leprechaun agradecemos sua preferência.</h1>
                    <p class="lead">Você será redirecionado em breve!</p>
                    
                    <div class="alert alert-success" role="alert">
                        <h4 class="alert-heading">Compra realizada com sucesso!</h4>
                        <p>Já reservamos seu lugar.</p>
                        <p class="mb-0">"Você é o criador do seu próprio mérito."</p>
                    </div>
                </div>
            </div>
        </div>
